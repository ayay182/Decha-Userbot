...
async def get_full_user(event):
    ...
    if event.reply_to_msg_id and not len(args) == 2:
        ...
        try:
            ...
            return await event.edit("`Terjadi Kesalahan... Mohon Lapor Ke Grup`", str(err))
...
CMD_HELP.update({
    "gban": "\
`.gban`\
\nUsage: Melakukan Banned Secara Global Ke Semua Grup Dimana Decha Sebagai Admin.\
\n\n`.ungban`\
