...
async def killdabot(event):
    ...
    await event.edit("`Mematikan Decha-Userbot....`")
    await asyncio.sleep(7)
    await event.delete()
    if BOTLOG:
        await event.client.send_message(BOTLOG_CHATID, "#SHUTDOWN \n"
                                        "`Decha-Userbot Telah Dimatikan`")
    await bot.disconnect()


@register(outgoing=True, pattern="^.restart$")
async def killdabot(event):
    await event.edit("`Restarting Decha-Userbot...`")
    await asyncio.sleep(10)
    await event.delete()
    if BOTLOG:
        await event.client.send_message(BOTLOG_CHATID, "#RESTARTBOT \n"
                                        "`Decha-Userbot Telah Di Restart`")
    await bot.disconnect()
...
async def reedme(e):
    await e.edit(
        ...
        "\n[Decha-Userbot Repo](https://github.com/Zora24/Decha-Userbot/blob/Decha-Userbot/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "❃ **Repo Userbot:** [Decha-Userbot](https://github.com/Zora24/Decha-Userbot)\n❃ **Pemilik:** [Alvin](t.me/liualvinas)"
    )
