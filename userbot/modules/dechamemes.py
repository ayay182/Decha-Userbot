...
async def _(event):
    ...
    if input_str == "gift":
        ...
        animation_chars = [
            ...
            "⬜⬜⬜\n⬜⬜⬜\n⬜⬜⬜",
            "⬜⬜\n⬜⬜",
            "Klik Hadiah Kamu [🎁](http://giphygifs.s3.amazonaws.com/media/5Y2bU7FqLOuzK/giphy.mp4)"]
...
async def _(event):
    ...
    if input_str == "police":
        ...
        animation_chars = [
            ...
            "🔵🔵🔵⬜⬜⬜🔴🔴🔴\n🔵🔵🔵⬜⬜⬜🔴🔴🔴\n🔵🔵🔵⬜⬜⬜🔴🔴🔴",
            "🔴🔴🔴⬜⬜⬜🔵🔵🔵\n🔴🔴🔴⬜⬜⬜🔵🔵🔵\n🔴🔴🔴⬜⬜⬜🔵🔵🔵",
            "**Polisi Sudah Menangkap Akun Ini**"
...
async def _(event):
    ...
    if input_str == "kill":
        ...
        animation_chars = [
            ...
            "------>;(^。^)ノ",
            "(￣ー￣) MATI",
            "**Target Berhasil Dibunuh (°̥̥̥̥̥̥̥̥•̀.̫•́°̥̥̥̥̥̥̥)**",
        ]
...
async def _(event):
    ...
    if input_str == "hack":
        ...
        animation_chars = [
            ...
            "`Hacking... 84%\n█████████████████████▒▒▒▒ `",
            "`Hacking... 100%\n█████████HACKED███████████ `",
            f"`Target Berhasil Di Hack...\n\nBayar Rp. 25.000 Kepada @{DEFAULTUSER} Atau Kasih Pizza 🍕`"]
...
async def _(event):
    ...
    if input_str == "whatsapp":
        ...
        animation_chars = [
            "Melihat Database WhatsApp Target...",
            " User online: True\nTelegram access: True\nMembaca Media Penyimpanan: True ",
            "Hacking... 0%\n[░░░░░░░░░░░░░░░░░░░░]\n`Mencari Folder WhatsApp...`\nETA: 0m, 20s",
            "Hacking... 11.07%\n[██░░░░░░░░░░░░░░░░░░]\n`Masih Mencari Folder WhatsApp...`\nETA: 0m, 18s",
            "Hacking... 20.63%\n[███░░░░░░░░░░░░░░░░░]\n`Menemukan Folder WhatsApp`\nETA: 0m, 16s",
            "Hacking... 34.42%\n[█████░░░░░░░░░░░░░░░]\n`Menemukan Folder WhatsApp`\nETA: 0m, 14s",
            "Hacking... 42.17%\n[███████░░░░░░░░░░░░░]\n`Mencari Database`\nETA: 0m, 12s",
            "Hacking... 55.30%\n[█████████░░░░░░░░░░░]\n`Menemukan msgstore.db.crypt12`\nETA: 0m, 10s",
            "Hacking... 64.86%\n[███████████░░░░░░░░░]\n`Menemukan msgstore.db.crypt12`\nETA: 0m, 08s",
            "Hacking... 74.02%\n[█████████████░░░░░░░]\n`Mencoba Decrypt Database...`\nETA: 0m, 06s",
            "Hacking... 86.21%\n[███████████████░░░░░]\n`Mencoba Decrypt Database...`\nETA: 0m, 04s",
            "Hacking... 93.50%\n[█████████████████░░░]\n`Decryption Database Berhasil!`\nETA: 0m, 02s",
            "Hacking... 100%\n[████████████████████]\n`Scanning File...`\nETA: 0m, 00s",
            "Hacking Complete!\nUploading file...",
            "Akun target Berhasil di Hack...!\n\n ✅ File Berhasil Di Upload Ke Server Hacker.\nWhatsApp Database:\n`./Hacked/msgstore.db.crypt12`"]
...
async def _(event):
    ...
    if input_str == "solar":
        ...
        for i in animation_ttl:
            await asyncio.sleep(animation_interval)
            await event.edit(animation_chars[i % 144])
...
async def _(event):
    ...
    if input_str == "vquickheal":
        ...
        animation_chars = [
            ...
            "`Quick Heal Total Security Checkup\n\n\nSubscription: Pru User\nValid Until: 31/12/2099\n\nFile Scanned... 84%\n█████████████████████▒▒▒▒ `",
            "`Quick Heal Total Security Checkup\n\n\nSubscription: Pru User\nValid Until: 31/12/2099\n\nFile Scanned... 100%\n█████████████████████████ `",
            "`Quick Heal Total Security Checkup\n\n\nSubscription: Pru User\nValid Until: 31/12/2099\n\nTask: 01 of 01 Files Scanned...\n\nReault:⚠️Virus Found⚠️\nMore Info: Trojan, Spyware, Adware`"]
...
async def _(event):
    ...
    if input_str == "call":
        ...
        animation_chars = [
            "`Meghubungi Istana Negara...`",
            "`Tersambung Dengan Istana Negara.`",
            "`Paspampres: Hallo Ini Paspampres Anda Siapa?`",
            f"`{DEFAULTUSER}: Saya `{DEFAULTUSER},`Tolong Sambungkan Saya Dengan Presiden`",
            f"`Paspampres Menyetujui Panggilan {DEFAULTUSER}.`",
            "`Menghubungi Presiden`",
            "`Tersambung Dengan Presiden`",
            f"`{DEFAULTUSER}: Hallo Pak Presiden Tolong Tangkap Orang Ini.`",
            "`Presiden: Boleh Saya Tau Anda Siapa?`",
            f"`{DEFAULTUSER}: Maaf Pak Saya` {DEFAULTUSER} ",
            f"`Presiden: Saya kira Siapa..., Orang Ini Kenapa` {DEFAULTUSER} `?.`",
            f"`{DEFAULTUSER}: Orang Ini Rese Pak.`",
            "`Presiden: Baiklah Nanti Saya Suruh Kapolri Untuk Menangkap Orang Ini`",
            f"`{DEFAULTUSER}: Terima Kasih Banyak Pak`",
            "`Presiden: Iya Sama-sama Nanti Kalau Ada Yang Rese Kabari Saya Lagi Ya.`",
            f"`{DEFAULTUSER}: Baik Pak Nanti Saya Kabari Bapak Lagi.`",
            f"`Presiden: Saya Akan Perintahkan Kapolri Sekarang, Sampai Jumpa Lagi `{DEFAULTUSER}",
            "`Sambungan Dengan Presiden Berakhir.`"]
...
async def _(event):
    ...
    if input_str == "wupload":
        ...
        animation_chars = [
            ...
            "DOWNLOADING... \n\n11.07% [██░░░░░░░░░░░░░░░░░░]\n\nETA: 0m, 18s",
            "DOWNLOADING... \n\n20.63% [███░░░░░░░░░░░░░░░░░]\n\nETA: 0m, 16s",
            "FILE DOWNLOADED, UPLOADING TO ADMIN'S WHATSAPP... \n\n34.42% [█████░░░░░░░░░░░░░░░]\n\nETA: 0m, 14s",
            "UPLOADING... \n\n42.17% [███████░░░░░░░░░░░░░]\n\nETA: 0m, 12s",
            "UPLOADING... \n\n55.30% [█████████░░░░░░░░░░░]\n\nETA: 0m, 10s",
            "UPLOADING... \n\n64.86% [███████████░░░░░░░░░]\n\nETA: 0m, 08s",
...
async def _(event):
    ...
    if x == 10:
        await event.edit("`\"What do we say to the Decha of Death?\nNot Today!\"`")
    if x == 11:
