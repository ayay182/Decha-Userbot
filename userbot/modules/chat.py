...
async def kickme(leave):
    ...
    await leave.edit("`Telah Meninggalkan Grup ツ`")
...
async def mute_chat(mute_e):
    ...
    await mute_e.edit("`Ssshssh Telah Membisukan Obrolan!`")
    await sleep(2)
    await mute_e.delete()
    if BOTLOG:
...
async def get_chatinfo(event):
    ...
    try:
        ...
        try:
            ...
            await event.edit("`Ini Adalah Grup/Channel Privasi Atau Dibanned Dari Sana`")
            return None
